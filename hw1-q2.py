...
def main():
    ...
    ### STEP 1 - Define the model {layers, activation function, foward previous two}
    ...
    ### STEP 3 - Training iterations {Clean optimizer, calculation of the loss,
    # backwards loss, optimizer step of weights}
